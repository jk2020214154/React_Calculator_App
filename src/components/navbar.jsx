        ...
        if(this.props.is_login){
            return (
                <li className="nav-item">
                    <Link className="nav-link active" to="/calculator/calculator">计算器</Link>
                </li>
            );
        }else return "";
    }
        ...
        if(this.props.is_login){
            return (
                <ul className="navbar-nav">
                    ...
                    <li className="nav-item">
                        ...
                        className="nav-link active" style={{cursor: "pointer"}} >退出</a>
                    </li>
                </ul>
            )
        }
            ...
            return (
                <ul className="navbar-nav">
                    ...
                    <li className="nav-item">
                        <Link className="nav-link active" to="/calculator/register">注册</Link>
                    </li>
            </ul>
            )
        }
        ...
        return (
            <nav className="navbar navbar-expand-lg navbar-light bg-primary">
                <div className="container">
                    <Link className="navbar-brand" to="/calculator">在线计算器</Link>
